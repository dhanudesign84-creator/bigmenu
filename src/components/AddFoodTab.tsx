...
export const AddFoodTab: React.FC<AddFoodTabProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Upload image to persistent storage if a new file is chosen
      if (selectedFile) {
        setUploading(true);
    ...
    <div className="bg-white rounded-3xl border border-gray-200/80 p-5 sm:p-7 shadow-xs">
      <div className="flex items-center justify-between pb-4 mb-5 border-b border-gray-100">
        <div>
          ...
          <p className="text-xs text-[#686868] mt-0.5">Create a delicious new item for your restaurant menu</p>
        </div>
        <button
          onClick={onCancel}
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          <label className="block text-xs font-bold uppercase tracking-wider text-[#1F1F1F] mb-2">
            Food Image
          </label>
          ...
          {imagePreview ? (
            <div className="relative rounded-2xl overflow-hidden border border-gray-200 bg-gray-50 max-w-sm">
              ...
              <div className="p-3 bg-white flex items-center justify-between border-t border-gray-100">
                <label className="text-xs font-bold text-[#0C831F] hover:underline cursor-pointer">
            ...
            <div className="border-2 border-dashed border-gray-300 hover:border-[#0C831F] rounded-2xl p-6 sm:p-8 text-center transition-colors bg-gray-50/50">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="e.g. Soft paneer cooked in rich buttery tomato gravy with fresh cream."
        ...
        <div className="flex items-center gap-3 pt-5 border-t border-gray-100">
          ...
          >
            ...
            <span>{uploading ? "Uploading Image..." : submitting ? "Saving Food..." : "Add Food"}</span>
          </button>
        </div>
      </form>
    </div>
